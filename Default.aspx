...
<![endif]-->
    <title>Energon Site Welcome Page</title>
    <!--[if gte mso 9]><xml>
 <o:DocumentProperties>
  <o:Subject>Energon Site Welcome Page</o:Subject>
  <o:Author>Vit Klich</o:Author>
  <o:Keywords>Himself</o:Keywords>  
  <o:Template>Normal</o:Template>
  <o:LastAuthor>Vit Klich</o:LastAuthor>
  <o:Revision>23</o:Revision>
  <o:TotalTime>300</o:TotalTime>
  <o:Created>2009-02-13T18:12:00Z</o:Created>
  <o:LastSaved>2009-08-26T19:04:00Z</o:LastSaved>
  <o:Pages>3</o:Pages>
  <o:Words>556</o:Words>
  <o:Characters>3174</o:Characters>
  <o:Category>Best but Jobless</o:Category>
  <o:Manager>Thesame Asstuff, Himself</o:Manager>
...
@page Section1
	...
	mso-header:url("index.files/header.htm") h1;
	mso-even-footer:url("index.files/header.htm") ef1;
	mso-footer:url("index.files/header.htm") f1;
	mso-first-header:url("index.files/header.htm") fh1;
	mso-first-footer:url("index.files/header.htm") ff1;
	mso-paper-source:0;}
div.Section1
	{page:Section1;
	mso-footnote-position:beneath-text;}
 /* List Definitions */
 @list l0
	{mso-list-id:1155562344;
	mso-list-type:hybrid;
	mso-list-template-ids:-468266518 68747265 68747267 68747269 68747265 68747267 68747269 68747265 68747267 68747269;}
@list l0:level1
	{mso-level-number-format:bullet;
	mso-level-text:\F0B7;
	mso-level-tab-stop:34.35pt;
...
<body onload='alert("Привет мир!!!");'> 
    ...
    <div>
        ...
        <table>
            <tr>
                <td class="style7" style="border: medium solid #000080">
            ...
            <tr>
                <td class="style3" align="left" valign="top" bgcolor="White">
                    <asp:TreeView ID="TreeView1" runat="server" DataSourceID="SiteMapDataSource1" 
                        BackColor="#CCFF66">
                    </asp:TreeView>
                    <asp:SiteMapDataSource ID="SiteMapDataSource1" runat="server" />
                        <img width=283 height=412
src="images/image001.jpg" align="right" hspace=12 v:shapes="_x0000_s1027" xml:lang="ru">
                    <br />
                    <br />
                    <br />
                    <br />
...
<table class=MsoTableWeb3 border=1 cellspacing=3 cellpadding=0
 style='mso-cellspacing:2.0pt;border:outset 3.0pt;mso-padding-alt:0cm 5.4pt 0cm 5.4pt;
 ...
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;height:24.0pt'>
  <td width=654 valign=top style='width:490.65pt;padding:0cm 5.4pt 0cm 5.4pt;
  height:24.0pt'>
...
<p class=MsoNormal style='margin-right:28.25pt;text-align:justify;text-indent:
1.0cm'><b style='mso-bidi-font-weight:normal'><span style='font-size:14.0pt;
color:yellow'><span style='mso-tab-count:4'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span><!--[if gte vml 1]><v:shape
 id="_x0000_i1025" type="#_x0000_t75" style='width:186.75pt;height:68.25pt'>
 <v:imagedata src="images/image002.gif" o:title="image002"/>
</v:shape><![endif]--><o:p></o:p></span></b></p>

<p class=MsoNormal><b style='mso-bidi-font-weight:normal'><span
style='font-size:16.0pt;color:lime'><o:p>&nbsp;<asp:Image ID="Image1" 
        runat="server" ImageUrl="~/Images/image002.gif" />
        <span lang="en-us">&nbsp;<asp:Image ID="Image2" runat="server" Height="50px" 
            ImageUrl="~/Images/thank.gif" Width="66px" />
        </span>
    </o:p></span></b></p>&nbsp;</asp:Panel>
            </td>
        </tr>            
  </table>    
    </div>
